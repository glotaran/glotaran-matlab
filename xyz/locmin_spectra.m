function[txt,txt2] = locmin_spectra(wavelength,spectra)
...
for i=1:size(spectra,1)
    [amplitude_min,idx]=min(spectra(i,:));
    wavelength_max=wavelength(idx,1);
    txt=num2str(amplitude_min,5);%Precision upto 4 digits 
    txt2=num2str(wavelength_max,3);

    t=text(wavelength_max,amplitude_min,txt2,'Color','blue','FontSize',10);
    t.FontWeight='bold';
